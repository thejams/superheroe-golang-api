...
func TestGetAll(t *testing.T) {
	t.Run("should return an array with 1 superheroe", func(t *testing.T) {
		...
		mockRepo.On("GetAll", context.TODO()).Return([]entity.Character{batman}, nil)
	...
	t.Run("should return error when  database connection fails", func(t *testing.T) {
		mockRepo := new(mock.Repository)
		ctrl := controller.NewController(mockRepo, nil)
		mockRepo.On("GetAll", context.TODO()).Return(nil, fmt.Errorf("error in database connection"))
...
func TestGetByID(t *testing.T) {
	t.Run("should return error when no superheroe is found", func(t *testing.T) {
		mockRepo := new(mock.Repository)
		ctrl := controller.NewController(mockRepo, nil)
		mockRepo.On("Get", "1", context.TODO()).Return(nil, fmt.Errorf("no superheroe with id %v found", 1))
	...
	t.Run("should return a superheroe", func(t *testing.T) {
		mockRepo := new(mock.Repository)
		ctrl := controller.NewController(mockRepo, nil)
		mockRepo.On("Get", "1", context.TODO()).Return(&batman, nil)
...
func TestAdd(t *testing.T) {
	t.Run("should return error when name of heroe already exists", func(t *testing.T) {
		...
		mockRepo.On("GetAll", context.TODO()).Return(sh, nil)
	...
	t.Run("should add a new superheroe", func(t *testing.T) {
		...
		mockRepo.On("GetAll", context.TODO()).Return(sh, nil)
		mockRepo.On("Add", &nh, context.TODO()).Return(&nh, nil)
	...
	t.Run("should error when data base insert operation fails", func(t *testing.T) {
		...
		mockRepo.On("GetAll", context.TODO()).Return(sh, nil)
		mockRepo.On("Add", &nh, context.TODO()).Return(nil, fmt.Errorf("Insert operation fail"))
		_, err := ctrl.Add(&nh, context.TODO())
...
func TestEdit(t *testing.T) {
	t.Run("should return error when heroe does not exists", func(t *testing.T) {
		...
		mockRepo := new(mock.Repository)
		ctrl := controller.NewController(mockRepo, nil)
		mockRepo.On("Edit", "1", &nh, context.TODO()).Return(nil, fmt.Errorf("Superheroe with ID %v does not exist", 2))
	...
	t.Run("should edit a superheroe information", func(t *testing.T) {
		...
		mockRepo.On("Edit", "1", &nh, context.TODO()).Return(&nh, nil)
...
func TestDelete(t *testing.T) {
	t.Run("should return error when heroe does not exists", func(t *testing.T) {
		mockRepo := new(mock.Repository)
		ctrl := controller.NewController(mockRepo, nil)
		mockRepo.On("Delete", "2", context.TODO()).Return("", fmt.Errorf("Superheroe with ID %v does not exist", 2))
	...
	t.Run("should delete a superheroe", func(t *testing.T) {
		mockRepo := new(mock.Repository)
		ctrl := controller.NewController(mockRepo, nil)
		mockRepo.On("Delete", "1", context.TODO()).Return("Character deleted 1", nil)
...
func BenchmarkByID(b *testing.B) {
	mockRepo := new(mock.Repository)
	ctrl := controller.NewController(mockRepo, nil)
	mockRepo.On("GetAll", context.TODO()).Return([]entity.Character{batman})
...
func BenchmarkAdd(b *testing.B) {
	...
	mockRepo.On("GetAll", context.TODO()).Return(sh)
	mockRepo.On("Add", &nh).Return(&nh)
...
func BenchmarkEdit(b *testing.B) {
	...
	mockRepo.On("Edit", &nh).Return(&nh, nil)
	mockRepo.On("GetAll", context.TODO()).Return(sh)
...
func BenchmarkDelete(b *testing.B) {
	...
	ctrl := controller.NewController(mockRepo, nil)
	mockRepo.On("GetAll", context.TODO()).Return(sh)
	mockRepo.On("Delete", "1").Return("Character deleted 1", nil)
